...
public class WritingGroups {
    ...
    /**
     * displayAllGroups will display all the information on the writing groups
     * listed in the table
     *
     * @param conn
     */
    ...
    /**
     * displayAllInfo will display all the information based on the given
     * groupName given and the books associated with them
     *
     * @param conn
